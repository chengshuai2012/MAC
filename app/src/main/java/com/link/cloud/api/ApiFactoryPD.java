 ...
 */
public class ApiFactoryPD {

    private static Map<String, Object> mCache = new HashMap();


    public static ApiService getApiService() {
        return getService("http://app.timeshuttlefit.com", ApiService.class);
    }
    ...
    public static Observable<ApiResponse<UserFace>> faceAdd(@Body RequestBindFace requestBindFace) {
        return getApiService().faceAdd(requestBindFace).map(new HttpResultFunc()).compose(SchedulersCompat.applyIoSchedulers());
    }
